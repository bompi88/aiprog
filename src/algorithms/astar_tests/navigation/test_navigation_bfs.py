...
class TestNavigation(unittest.TestCase):
    def setUp(self):
        ...
        self.task_1 = NavigationGrid(MapReader(MapReader.read_map('ex_simple.txt')))
    ...
    def test_solve(self):
        ...
        self.assertEqual(proposal_state_task_1.solution_length(), self.solution_task_1)
        self.assertEqual(proposal_state_task_2.solution_length(), self.solution_task_2)
        self.assertEqual(proposal_state_task_3.solution_length(), self.solution_task_3)
        self.assertEqual(proposal_state_task_4.solution_length(), self.solution_task_4)
        self.assertEqual(proposal_state_task_5.solution_length(), self.solution_task_5)
        self.assertEqual(proposal_state_task_6.solution_length(), self.solution_task_6)
        self.assertEqual(proposal_state_task_7.solution_length(), self.solution_task_7)
        self.assertEqual(proposal_state_task_8.solution_length(), self.solution_task_8)
        self.assertEqual(proposal_state_task_9.solution_length(), self.solution_task_9)
